                                    ...
                                    <table border="1" style="border-color: #ffffff;" width="100%" cellpadding="1" cellspacing="1">
                                        ...
                                        @foreach($allMarks as $key => $mark)
                                            ...
                                            <tr>
                                                ...
                                                @php
                                                    $grade_marks = App\Models\StudentMarksGrade::where([['start_marks','<=', (int)$get_mark],['end_marks', '>=',(int)$get_mark ]])->first();
                                ...
                                <div class="col-md-12">
                                    ...
                                    <table border="1" style="border-color: #ffffff;" width="100%" cellpadding="1" cellspacing="1">
                                        @php
                                            ...
                                            $total_grade = App\Models\StudentMarksGrade::where([['start_point','<=',$point_for_letter_grade],['end_point','>=',$point_for_letter_grade]])->first();

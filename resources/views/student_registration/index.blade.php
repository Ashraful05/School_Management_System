                                        ...
                                        @foreach($assignedStudents as $row=>$data)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a target="_blank" href="{{ route('student.registration.details',$data->student_id) }}" class="btn btn-rounded btn-danger" title="Description"><i class="fa fa-file-pdf-o"></i></a>

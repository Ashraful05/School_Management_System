...
@section('title','Edit Employee Leave Form')
                                ...
                                <div class="row">
                                            ...
                                            <div class="controls">
                                                <select name="leave_purpose_id" id="leave_purpose_id" class="form-control">
                                                    ...
                                                    @foreach($leavePurposes as $leavePurpose)
                                                        <option value="{{ $leavePurpose->id }}" {{ ($leavePurpose->id == $editData->leave_purpose_id)?'selected':'' }}>{{ $leavePurpose->name }}</option>
                                                    @endforeach
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="date" name="start_date" value="{{ old('start_date',$editData->start_date) }}" class="form-control">
                                                @error('start_date')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="date" name="end_date" value="{{ old('end_date',$editData->end_date) }}" class="form-control">
                                                @error('end_date')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>

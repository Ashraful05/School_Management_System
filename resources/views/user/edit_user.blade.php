                    ...
                    <div class="row">
                        <div class="col">
                            @if($errors->any())
                                ...
                                @endforeach
                            @endif
                            <form action="{{ route('user_update',$editUser->id) }}" method="post" >
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="name" value="{{ old('name',$editUser->name) }}" class="form-control" >
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <h5>User Email <span class="text-danger">*</span></h5>
                                            <div class="controls">
                                                <input type="email" name="email" value="{{ old('email',$editUser->email) }}" class="form-control" >
                                            </div>
                                        </div>
